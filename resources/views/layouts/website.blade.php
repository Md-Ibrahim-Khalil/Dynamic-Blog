            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="col-4 site-logo">
                        <a href="index.html" class="text-black h2 mb-0">Imran Blog</a>
                    </div>
            ...
            <div class="container">
                    ...
                    <div class="col-md-4">
                        <div>
                            ...
                            <p>
                                ...
                                @if($setting->twitter)<a target="_blank" href="{{ $setting->twitter }}"><span
                                        class="icon-twitter p-2"></span></a> @endif
                                @if($setting->instagram)<a target="_blank" href="{{ $setting->instagram }}"><span
                                        class="icon-instagram p-2"></span></a> @endif
                                @if($setting->reddit)<a target="_blank" href="{{ $setting->reddit }}"><span
                                        class="icon-rss p-2"></span></a> @endif
                                @if($setting->email)<a target="_blank" href="{{ $setting->email }}"><span
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <p>
                            Copyright © {{ $setting->copyright }} | All Rights Reserved.
                        </p>
                    </div>
                </div>
            </div>
